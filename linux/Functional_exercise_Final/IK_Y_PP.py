# FAIRINO COBOT — PURE Y-AXIS ADMITTANCE
...
# ============================================================================
# MAIN LOOP — PURE Y-AXIS ADMITTANCE WITH 100mm/s LIMIT
# ============================================================================
def control_loop():
    ...
    print("\n" + "="*70)
    print(" PERFECT Y-AXIS ADMITTANCE CONTROL (MAX 60°/s per joint)")
    print(" Push forward/backward on tool → moves smoothly in Y (world)")
...
if __name__ == "__main__":
    ...
    init_ft_sensor()
    calibrate_baseline()
    print("\nSTARTING PURE Y-AXIS ADMITTANCE (60°/s joint limit)")
    print("Push/pull the tool along Y → moves smoothly, safe 60°/s limit per joint!")
    try:
        control_loop()
