...
M = [10.0, 10.0, 10.0, 20.0, 20.0, 0.0]              # Virtual mass per joint (joint 6 fixed)
B = [5.0, 4.0, 5.0, 50.0, 50.0, 0.0]         # Damping per joint
K = [30.0, 20.0, 30.0, 30.0, 30.0, 0.0]         # [0]*6:WONT RETURN TO  ORIGINAL POSITION( Spring stiffness per joint)
force_thresholds = [2.5, 2.5, 30.0, 1.2, 1.2, 1.2]  # Force thresholds
