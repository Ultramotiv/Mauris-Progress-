# Adaptive Resisted 
# code with NEW mapping 
# so the resistance depends upon the user's inpiut! 
...
RESISTANCE_PERCENTAGE = 50  # Set your desired resistance level here (0-100)
...
def apply_resistance_force(joint2_force, resistance_percent):
    """
    ...
    effective_force = joint2_force * (1.0 - resistance_factor)
...
def control_loop():
    ...
    while True:
        ...
        forces_with_resistance = [apply_resistance_force(force, RESISTANCE_PERCENTAGE) for force in world_forces]
