...
<head>
    ...
    <style>
        body { 
            font-family: Arial, sans-serif; 
            background-color: #44b8a6;  /* SOLID COLOR */
            margin: 0; 
            padding: 0;
            min-height: 100vh;
        }
    ...
    <script>
        ...
        function toggleDragMode() {
            ...
            .then(data => {
                if(data.status === 'success') {
                    ...
                    // Disable movement buttons when drag mode is active
        ...
        function updateTelemetry() {
            ...
            .then(data => {
                ...
                document.getElementById('z-value').textContent = data.tcp_z.toFixed(2);  // <-- CHANGED
            })
